...
export default class TelaIntroducao extends React.Component{
    render(){
        ...
        return <div>
            ...
            <div className='texto-intro'> Primeiramente, você deve preencher todos os campos pedidos, seja a quantidade usada em cada delicioso sanduíche de algum ingrediente, ou a demanda de algum tipo de cachorro quente, no caso, o cachorro quente seria somente pão com salsicha, dando 4 opções de cachorro quente com o resto dos ingredientes.</div>
